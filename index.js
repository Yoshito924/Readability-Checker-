...
function PaintText() {
    ...
    text = text
        //高確率で直すべき赤チェック表現
        .replace(/という/g, '<mark1>という</mark1>')
        .replace(/といった/g, '<mark1>といった</mark1>')

        .replace(/ような/g, '<mark1>ような</mark1>')
        .replace(/ように/g, '<mark1>ように</mark1>')

        .replace(/もの/g, '<mark1>もの</mark1>')
        .replace(/こと/g, '<mark1>こと</mark1>')

        .replace(/ついて/g, '<mark1>ついて</mark1>')
        .replace(/くらい/g, '<mark1>くらい</mark1>')
        .replace(/ぐらい/g, '<mark1>ぐらい</mark1>')

        //受け身表現
        .replace(/られる/g, '<mark1>られる</mark1>')
        .replace(/られた/g, '<mark1>られた</mark1>')
        .replace(/られて/g, '<mark1>られて</mark1>')
        .replace(/られます/g, '<mark1>られます</mark1>')
        .replace(/られました/g, '<mark1>られました</mark1>')

        //見直すべき
        .replace(/など/g, '<mark2>など</mark2>')

        .replace(/が、/g, '<mark2>が、</mark2>')
        .replace(/ましたが/g, '<mark2>ましたが</mark2>')
        .replace(/りますが/g, '<mark2>りますが</mark2>')
        .replace(/けれど/g, '<mark2>けれど</mark2>')
        .replace(/だけど/g, '<mark2>だけど</mark2>')

        .replace(/いろんな/g, '<mark2>いろんな</mark2>')
        .replace(/じゃあ/g, '<mark2>じゃあ</mark2>')
        .replace(/それから/g, '<mark2>それから</mark2>')
        .replace(/ちっとも/g, '<mark2>ちっとも</mark2>')

        .replace(/まぁ/g, '<mark2>まぁ</mark2>')
        .replace(/まあ/g, '<mark2>まあ</mark2>')

        .replace(/ところ/g, '<mark2>ところ</mark2>')

        .replace(/とともに/g, '<mark2>とともに</mark2>')
        .replace(/と共に/g, '<mark2>と共に</mark2>')

        .replace(/なるはや/g, '<mark2>なるはや</mark2>')
        .replace(/説明不要/g, '<mark2>説明不要</mark2>')

        .replace(/たり/g, '<mark2>たり</mark2>')

        .replace(/マジ/g, '<mark2>マジ</mark2>')
        .replace(/同様/g, '<mark2>同様</mark2>')
        .replace(/絶対/g, '<mark2>絶対</mark2>')
        .replace(/本当/g, '<mark2>本当</mark2>')
        .replace(/こだわり/g, '<mark2>こだわり</mark2>')
        .replace(/いくつか/g, '<mark2>いくつか</mark2>')
        .replace(/とくに/g, '<mark2>とくに</mark2>')
        .replace(/特に/g, '<mark2>特に</mark2>')
        .replace(/いろいろ/g, '<mark2>いろいろ</mark2>')
        .replace(/色々/g, '<mark2>色々</mark2>')
        .replace(/おそらく/g, '<mark2>おそらく</mark2>')
        .replace(/恐らく/g, '<mark2>恐らく</mark2>')
        .replace(/とても/g, '<mark2>とても</mark2>')
        .replace(/いっぱい/g, '<mark2>いっぱい</mark2>')
        .replace(/かなり/g, '<mark2>かなり</mark2>')
        .replace(/きっと/g, '<mark2>きっと</mark2>')
        .replace(/すごく/g, '<mark2>すごく</mark2>')
        .replace(/とても/g, '<mark2>とても</mark2>')
        .replace(/ちょっと/g, '<mark2>ちょっと</mark2>')
        .replace(/いわゆる/g, '<mark2>いわゆる</mark2>')

        //特定の漢字表現
        .replace(/所謂/g, '<mark2>所謂</mark2>')
        .replace(/我が/g, '<mark2>我が</mark2>')
        .replace(/凡そ/g, '<mark2>凡そ</mark2>')
        .replace(/及び/g, '<mark2>及び</mark2>')
        .replace(/然し/g, '<mark2>然し</mark2>')
        .replace(/即ち/g, '<mark2>即ち</mark2>')
        .replace(/何故/g, '<mark2>何故</mark2>')
        .replace(/是非/g, '<mark2>是非</mark2>')
        .replace(/段々/g, '<mark2>段々</mark2>')
        .replace(/或いは/g, '<mark2>或いは</mark2>')
        .replace(/予め/g, '<mark2>予め</mark2>')
        .replace(/流石/g, '<mark2>流石</mark2>')
        .replace(/更に/g, '<mark2>更に</mark2>')
        .replace(/故に/g, '<mark2>故に</mark2>')
        .replace(/因みに/g, '<mark2>因みに</mark2>')
        .replace(/並びに/g, '<mark2>並びに</mark2>')
        .replace(/却って/g, '<mark2>却って</mark2>')
        .replace(/直に/g, '<mark2>直に</mark2>')
        .replace(/等/g, '<mark2>等</mark2>')
        .replace(/程/g, '<mark2>程</mark2>')
        .replace(/筈/g, '<mark2>筈</mark2>')
        .replace(/殆ど/g, '<mark2>殆ど</mark2>')
        .replace(/僅か/g, '<mark2>僅か</mark2>')
        .replace(/迄/g, '<mark2>迄</mark2>')
        .replace(/概ね/g, '<mark2>概ね</mark2>')
        .replace(/余り/g, '<mark2>余り</mark2>')
        .replace(/人達/g, '<mark2>人達</mark2>')
        .replace(/一寸/g, '<mark2>一寸</mark2>')
        .replace(/但し/g, '<mark2>但し</mark2>')
        .replace(/敢えて/g, '<mark2>敢えて</mark2>')
        .replace(/丁度/g, '<mark2>丁度</mark2>')
        .replace(/出来る/g, '<mark2>出来る</mark2>')
        .replace(/可笑しい/g, '<mark2>可笑しい</mark2>')
        .replace(/由々しい/g, '<mark2>由々しい</mark2>')
        .replace(/有る/g, '<mark2>有る</mark2>')
        .replace(/無い/g, '<mark2>無い</mark2>')
        //注意するべき指示語

        .replace(/これ/g, '<mark3>これ</mark3>')
        .replace(/これら/g, '<mark3>これら</mark3>')
        .replace(/ここ/g, '<mark3>ここ</mark3>')
        .replace(/こちら/g, '<mark3>こちら</mark3>')
        .replace(/こっち/g, '<mark3>こっち</mark3>')
        .replace(/この/g, '<mark3>この</mark3>')
        .replace(/こう/g, '<mark3>こう</mark3>')
        .replace(/こんな/g, '<mark3>こんな</mark3>')
        .replace(/こいつ/g, '<mark3>こいつ</mark3>')

        .replace(/それ/g, '<mark3>それ</mark3>')
        .replace(/それら/g, '<mark3>それら</mark3>')
        .replace(/そこ/g, '<mark3>そこ</mark3>')
        .replace(/そちら/g, '<mark3>そちら</mark3>')
        .replace(/そっち/g, '<mark3>そっち</mark3>')
        .replace(/その/g, '<mark3>その</mark3>')
        .replace(/そう/g, '<mark3>そう</mark3>')
        .replace(/そんな/g, '<mark3>そんな</mark3>')
        .replace(/そいつ/g, '<mark3>そいつ</mark3>')

        .replace(/あれ/g, '<mark3>あれ</mark3>')
        .replace(/あそこ/g, '<mark3>あそこ</mark3>')
        .replace(/あちら/g, '<mark3>あちら</mark3>')
        .replace(/あっち/g, '<mark3>あっち</mark3>')
        .replace(/あの/g, '<mark3>あの</mark3>')
        .replace(/ああ/g, '<mark3>ああ</mark3>')
        .replace(/あんな/g, '<mark3>あんな</mark3>')
        .replace(/あいつ/g, '<mark3>あいつ</mark3>')

        .replace(/どれ/g, '<mark3>どれ</mark3>')
        .replace(/どこ/g, '<mark3>どこ</mark3>')
        .replace(/どちら/g, '<mark3>どちら</mark3>')
        .replace(/どっち/g, '<mark3>どっち</mark3>')
        .replace(/どの/g, '<mark3>どの</mark3>')
        .replace(/どう/g, '<mark3>どう</mark3>')
        .replace(/どんな/g, '<mark3>どんな</mark3>')
        .replace(/どいつ/g, '<mark3>どいつ</mark3>')

        .replace(/コレ/g, '<mark3>コレ</mark3>')
        .replace(/其れ/g, '<mark3>其れ</mark3>')
        .replace(/此処/g, '<mark3>此処</mark3>')
        .replace(/其処/g, '<mark3>其処</mark3>')
        .replace(/何処/g, '<mark3>何処</mark3>')
        .replace(/何時/g, '<mark3>何時</mark3>')
        .replace(/或る/g, '<mark3>或る</mark3>')
        .replace(/此の/g, '<mark3>此の</mark3>')
        .replace(/其の/g, '<mark3>其の</mark3>')

        .replace(/貴方/g, '<mark3>貴方</mark3>')
        .replace(/何方/g, '<mark3>何方</mark3>')

        //その他注意するべき表現
        .replace(/ソーシャルネットワークサービス/g, '<mark6>ソーシャルネットワークサービス</mark6>')
        .replace(/ジャスト.インフォメーション/g, '<mark6>ジャスト・インフォメーション</mark6>')
        .replace(/グローバル.スタンダード/g, '<mark6>グローバル.スタンダード</mark6>')
        .replace(/ダイナミックプライシング/g, '<mark6>ダイナミックプライシング</mark6>')
        .replace(/デファクト.スタンダード/g, '<mark6>デファクト・スタンダード</mark6>')
        .replace(/コストパフォーマンス /g, '<mark6>コストパフォーマンス </mark6>')
        .replace(/スクラップアンドビルド/g, '<mark6>スクラップアンドビルド</mark6>')
        .replace(/デファクトスタンダード/g, '<mark6>デファクトスタンダード</mark6>')
        .replace(/コンティンジェンシー/g, '<mark6>コンティンジェンシー</mark6>')
        .replace(/ブランド.エクイティ/g, '<mark6>ブランド・エクイティ</mark6>')
        .replace(/ブランドエクイティ/g, '<mark6>ブランドエクイティ</mark6>')
        .replace(/エクスクルージョン/g, '<mark6>エクスクルージョン</mark6>')
        .replace(/ジャスト.アイデア/g, '<mark6>ジャスト・アイデア</mark6>')
        .replace(/ダイバーシティ /g, '<mark6>ダイバーシティ </mark6>')
        .replace(/ベストプラクティス/g, '<mark6>ベストプラクティス</mark6>')
        .replace(/アウトソーシング/g, '<mark6>アウトソーシング</mark6>')
        .replace(/アクセシビリティ/g, '<mark6>アクセシビリティ</mark6>')
        .replace(/インタラクティブ/g, '<mark6>インタラクティブ</mark6>')
        .replace(/インテリジェンス/g, '<mark6>インテリジェンス</mark6>')
        .replace(/インフルエンサー/g, '<mark6>インフルエンサー</mark6>')
        .replace(/エスカレーション/g, '<mark6>エスカレーション</mark6>')
        .replace(/コアコンピタンス/g, '<mark6>コアコンピタンス</mark6>')
        .replace(/コンプライアンス/g, '<mark6>コンプライアンス</mark6>')
        .replace(/サードパーティー/g, '<mark6>サードパーティー</mark6>')
        .replace(/サステナビリティ/g, '<mark6>サステナビリティ</mark6>')
        .replace(/ジャストアイデア/g, '<mark6>ジャストアイデア</mark6>')
        .replace(/シンギュラリティ/g, '<mark6>シンギュラリティ</mark6>')
        .replace(/ステークホルダー/g, '<mark6>ステークホルダー</mark6>')
        .replace(/データマイニング/g, '<mark6>データマイニング</mark6>')
        .replace(/ニアリーイコール/g, '<mark6>ニアリーイコール</mark6>')
        .replace(/ネゴシエーション/g, '<mark6>ネゴシエーション</mark6>')
        .replace(/ユーティリティー/g, '<mark6>ユーティリティー</mark6>')
        .replace(/レギュレーション/g, '<mark6>レギュレーション</mark6>')
        .replace(/アウトバウンド/g, '<mark6>アウトバウンド</mark6>')
        .replace(/イテレーション/g, '<mark6>イテレーション</mark6>')
        .replace(/イノベーション/g, '<mark6>イノベーション</mark6>')
        .replace(/インクルーシブ/g, '<mark6>インクルーシブ</mark6>')
        .replace(/インセンティブ/g, '<mark6>インセンティブ</mark6>')
        .replace(/エクスキューズ/g, '<mark6>エクスキューズ</mark6>')
        .replace(/オポチュニティ/g, '<mark6>オポチュニティ</mark6>')
        .replace(/オペレーション/g, '<mark6>オペレーション</mark6>')
        .replace(/キュレーション/g, '<mark6>キュレーション</mark6>')
        .replace(/コミットメント/g, '<mark6>コミットメント</mark6>')
        .replace(/コモディティ化/g, '<mark6>コモディティ化</mark6>')
        .replace(/コンソーシアム/g, '<mark6>コンソーシアム</mark6>')
        .replace(/コンバージョン/g, '<mark6>コンバージョン</mark6>')
        .replace(/コンピテンシー/g, '<mark6>コンピテンシー</mark6>')
        .replace(/ステートメント/g, '<mark6>ステートメント</mark6>')
        .replace(/スレッショルド/g, '<mark6>スレッショルド</mark6>')
        .replace(/ダイバーシティ/g, '<mark6>ダイバーシティ</mark6>')
        .replace(/ドラスティック/g, '<mark6>ドラスティック</mark6>')
        .replace(/パフォーマンス/g, '<mark6>パフォーマンス</mark6>')
        .replace(/フィードバック/g, '<mark6>フィードバック</mark6>')
        .replace(/フィジビリティ/g, '<mark6>フィジビリティ</mark6>')
        .replace(/プライオリティ/g, '<mark6>プライオリティ</mark6>')
        .replace(/プログレッシブ/g, '<mark6>プログレッシブ</mark6>')
        .replace(/フロントエンド/g, '<mark6>フロントエンド</mark6>')
        .replace(/マイルストーン/g, '<mark6>マイルストーン</mark6>')
        .replace(/モチベーション/g, '<mark6>モチベーション</mark6>')
        .replace(/リノベーション/g, '<mark6>リノベーション</mark6>')
        .replace(/アサーティブ/g, '<mark6>アサーティブ</mark6>')
        .replace(/アライアンス/g, '<mark6>アライアンス</mark6>')
        .replace(/アンバサダー/g, '<mark6>アンバサダー</mark6>')
        .replace(/イニシアチブ/g, '<mark6>イニシアチブ</mark6>')
        .replace(/イノベーター/g, '<mark6>イノベーター</mark6>')
        .replace(/インバウンド/g, '<mark6>インバウンド</mark6>')
        .replace(/エコシステム/g, '<mark6>エコシステム</mark6>')
        .replace(/オーソライズ/g, '<mark6>オーソライズ</mark6>')
        .replace(/クライアント/g, '<mark6>クライアント</mark6>')
        .replace(/クロージング/g, '<mark6>クロージング</mark6>')
        .replace(/コミュニティ/g, '<mark6>コミュニティ</mark6>')
        .replace(/コンセンサス/g, '<mark6>コンセンサス</mark6>')
        .replace(/コンテキスト/g, '<mark6>コンテキスト</mark6>')
        .replace(/コンテクスト/g, '<mark6>コンテクスト</mark6>')
        .replace(/ディシジョン/g, '<mark6>ディシジョン</mark6>')
        .replace(/ディシジョン/g, '<mark6>ディシジョン</mark6>')
        .replace(/デッドライン/g, '<mark6>デッドライン</mark6>')
        .replace(/バックエンド/g, '<mark6>バックエンド</mark6>')
        .replace(/ハレーション/g, '<mark6>ハレーション</mark6>')
        .replace(/ハンドリング/g, '<mark6>ハンドリング</mark6>')
        .replace(/フィーチャー/g, '<mark6>フィーチャー</mark6>')
        .replace(/フルコミット/g, '<mark6>フルコミット</mark6>')
        .replace(/ベネフィット/g, '<mark6>ベネフィット</mark6>')
        .replace(/ペンディング/g, '<mark6>ペンディング</mark6>')
        .replace(/ボトルネック/g, '<mark6>ボトルネック</mark6>')
        .replace(/ポリバレント/g, '<mark6>ポリバレント</mark6>')
        .replace(/モノリシック/g, '<mark6>モノリシック</mark6>')
        .replace(/リスクヘッジ/g, '<mark6>リスクヘッジ</mark6>')
        .replace(/アイディア/g, '<mark6>アイディア</mark6>')
        .replace(/アクセプト/g, '<mark6>アクセプト</mark6>')
        .replace(/アジェンダ/g, '<mark6>アジェンダ</mark6>')
        .replace(/アジャイル/g, '<mark6>アジャイル</mark6>')
        .replace(/アジャスト/g, '<mark6>アジャスト</mark6>')
        .replace(/エビデンス/g, '<mark6>エビデンス</mark6>')
        .replace(/カバレッジ/g, '<mark6>カバレッジ</mark6>')
        .replace(/カバレッジ/g, '<mark6>カバレッジ</mark6>')
        .replace(/コンセプト/g, '<mark6>コンセプト</mark6>')
        .replace(/コンテンツ/g, '<mark6>コンテンツ</mark6>')
        .replace(/コンパイル/g, '<mark6>コンパイル</mark6>')
        .replace(/シュリンク/g, '<mark6>シュリンク</mark6>')
        .replace(/スクリプト/g, '<mark6>スクリプト</mark6>')
        .replace(/セグメント/g, '<mark6>セグメント</mark6>')
        .replace(/ゼロベース/g, '<mark6>ゼロベース</mark6>')
        .replace(/デフォルト/g, '<mark6>デフォルト</mark6>')
        .replace(/ノーティス/g, '<mark6>ノーティス</mark6>')
        .replace(/バジェット/g, '<mark6>バジェット</mark6>')
        .replace(/パラダイム/g, '<mark6>パラダイム</mark6>')
        .replace(/ハンズオン/g, '<mark6>ハンズオン</mark6>')
        .replace(/フィジビリ/g, '<mark6>フィジビリ</mark6>')
        .replace(/フィックス/g, '<mark6>フィックス</mark6>')
        .replace(/マテリアル/g, '<mark6>マテリアル</mark6>')
        .replace(/ミッション/g, '<mark6>ミッション</mark6>')
        .replace(/ユビキタス/g, '<mark6>ユビキタス</mark6>')
        .replace(/リテラシー/g, '<mark6>リテラシー</mark6>')
        .replace(/ASAP/g, '<mark6>ASAP</mark6>')
        .replace(/MECE/g, '<mark6>MECE</mark6>')
        .replace(/アグリー/g, '<mark6>アグリー</mark6>')
        .replace(/アセット/g, '<mark6>アセット</mark6>')
        .replace(/アサイン/g, '<mark6>アサイン</mark6>')
        .replace(/イシュー/g, '<mark6>イシュー</mark6>')
        .replace(/オンスケ/g, '<mark6>オンスケ</mark6>')
        .replace(/キャズム/g, '<mark6>キャズム</mark6>')
        .replace(/コミット/g, '<mark6>コミット</mark6>')
        .replace(/サポート/g, '<mark6>サポート</mark6>')
        .replace(/サンプル/g, '<mark6>サンプル</mark6>')
        .replace(/シナジー/g, '<mark6>シナジー</mark6>')
        .replace(/スキーム/g, '<mark6>スキーム</mark6>')
        .replace(/デプロイ/g, '<mark6>デプロイ</mark6>')
        .replace(/ドリブン/g, '<mark6>ドリブン</mark6>')
        .replace(/トレンド/g, '<mark6>トレンド</mark6>')
        .replace(/ナレッジ/g, '<mark6>ナレッジ</mark6>')
        .replace(/ノウハウ/g, '<mark6>ノウハウ</mark6>')
        .replace(/バッファ/g, '<mark6>バッファ</mark6>')
        .replace(/ファクト/g, '<mark6>ファクト</mark6>')
        .replace(/フェーズ/g, '<mark6>フェーズ</mark6>')
        .replace(/ミーシー/g, '<mark6>ミーシー</mark6>')
        .replace(/ミッシー/g, '<mark6>ミッシー</mark6>')
        .replace(/メソッド/g, '<mark6>メソッド</mark6>')
        .replace(/メディア/g, '<mark6>メディア</mark6>')
        .replace(/メンター/g, '<mark6>メンター</mark6>')
        .replace(/ユーザー/g, '<mark6>ユーザー</mark6>')
        .replace(/ユーザー/g, '<mark6>ユーザー</mark6>')
        .replace(/リソース/g, '<mark6>リソース</mark6>')
        .replace(/リバイズ/g, '<mark6>リバイズ</mark6>')
        .replace(/ルーチン/g, '<mark6>ルーチン</mark6>')
        .replace(/レイヤー/g, '<mark6>レイヤー</mark6>')
        .replace(/2\.0/g, '<mark6>2.0</mark6>')
        .replace(/FYI/g, '<mark6>FYI</mark6>')
        .replace(/IoT/g, '<mark6>IoT</mark6>')
        .replace(/KPI/g, '<mark6>KPI</mark6>')
        .replace(/コスパ/g, '<mark6>コスパ</mark6>')
        .replace(/タイト/g, '<mark6>タイト</mark6>')
        .replace(/ツール/g, '<mark6>ツール</mark6>')
        .replace(/テレコ/g, '<mark6>テレコ</mark6>')
        .replace(/ニッチ/g, '<mark6>ニッチ</mark6>')
        .replace(/ノルマ/g, '<mark6>ノルマ</mark6>')
        .replace(/マスト/g, '<mark6>マスト</mark6>')
        .replace(/マター/g, '<mark6>マター</mark6>')
        .replace(/マター/g, '<mark6>マター</mark6>')
        .replace(/モダン/g, '<mark6>モダン</mark6>')
        .replace(/リスケ/g, '<mark6>リスケ</mark6>')
